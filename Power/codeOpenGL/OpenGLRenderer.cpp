...
namespace ow {
	...
	void OpenGLRenderer::DrawOpposite(Image& file, int xCoord, int yCoord)
	{
		float vertices[] = {
			xCoord,                     yCoord,                     1.0f, 0.0f,
			xCoord,                     yCoord + file.getHeight(),  1.0f, 1.0f,
			xCoord + file.getWidth(),   yCoord + file.getHeight(),  0.0f, 1.0f, 
			xCoord + file.getWidth(),   yCoord,                     0.0f, 0.0f  
		};
	...
	void OpenGLRenderer::DrawOpposite(Image& file, int xCoord, int yCoord, Shaders& shader)
	{
		float vertices[] = {
			xCoord,                     yCoord,                     1.0f, 0.0f,
			xCoord,                     yCoord + file.getHeight(),  1.0f, 1.0f,
